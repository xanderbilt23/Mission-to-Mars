...
for hemisphere in range(4):
    ...
    h_img_url_rel = h_img_soup.find('img', class_='wide-image').get('src')

    hemispheres['img_url'] = f'https://marshemispheres.com/{h_img_url_rel}'

    hemispheres['title'] = h_img_soup.find('h2', class_='title').get_text()
